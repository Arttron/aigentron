...
`VERSION=0.1.8 sudo sh install.sh` silently drops `VERSION`):
```bash
curl -fsSL https://raw.githubusercontent.com/Arttron/aigentron/main/install.sh | sudo INSTALL_MODE=bare VERSION=0.1.8 sh
```
